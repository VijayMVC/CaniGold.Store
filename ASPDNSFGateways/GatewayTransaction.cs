...
namespace AspDotNetStorefrontGateways
{
	...
	public class GatewayTransaction
	{
		...
		public int RecurringOrderNumberOriginal
		{
			get; set;
		}
		...
		private string CallGateway(string gateway)
		{
			...
			if(processor is ISagePayPiGatewayProcessor)
			{
				var sagePayPi = (ISagePayPiGatewayProcessor)processor;
				sagePayPi.TransactionType = TransactionType;
				sagePayPi.TransactionId = TransactionId;
				sagePayPi.RecurringOrderNumberOriginal = RecurringOrderNumberOriginal;
			}

			result = processor.ProcessCard(
				this.OrderNumber,
                                        this.CustomerID,
                                        this.OrderTotal,
