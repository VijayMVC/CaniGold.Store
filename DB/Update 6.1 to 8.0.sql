...
/* *** ASPDOTNETSTOREFRONT v6.1.x.x to v8.0 DB update [dbo].SCRIPT *** */
/*                                                                     */
/*                                                                     */
...
/*                                                                     */
/*                                                                     */
/* Run this script to update ANY 6.1.x.x version to the latest version */
/*                                                                     */
/* ******************************************************************* */
...
/**********************************  table mods and creates  **********************************/
    ...
    if not exists (select * From syscolumns where id = object_id('GiftCard') and name = 'DisabledByAdministrator') 
        alter table dbo.GiftCard add  DisabledByAdministrator tinyint constraint DF_GiftCard_DisabledByAdministrator default(0) NOT NULL
    go
    ...
    if not exists (select * From syscolumns where id = object_id('GiftCardUsage') and name = 'UsageTypeID') 
        alter table dbo.GiftCardUsage add UsageTypeID int  NOT NULL constraint DF_GiftCardUsage_UsageTypeID default(0)
    go
