...
<asp:Content ContentPlaceHolderID="head" runat="server">
	<style type="text/css">
		...
		#buysafeContent .container {
			margin: 0 auto;
			width: 900px;
		}

		#buysafeContent .content {
		...
		#buysafeContent .dottedline_blue {
		...
		#buysafeContent .footerText, #buysafeContent .footerText a {
			color: #fff;
			font-size: 11px;
		}

		#buysafeContent .imgBorder {
			border: 5px solid #e2e2e2;
		}

		#buysafeContent .maincontent_home {
			margin: auto;
			padding: 0;
			width: 900px;
			height: 266px;
		...
		#buysafeContent .ProductNameText {
			color: #2393d1;
		...
		#buysafeContent .right {
			text-align: right;
		}

		#buysafeContent .sideTitle {
			color: #000;
			font-size: 14px;
			font-weight: bold;
			padding-bottom: 5px;
		...
		#buysafeContent .tocLink a, #buysafeContent .sideText {
			font-size: 11px;
		}

		#buysafeContent .topNote a {
			color: #3d3d3d;
		}

		#buysafeContent .topNote {
			font-size: 10px;
			color: #656565;
		...
		#buysafeContent a {
			...
			#buysafeContent a:hover {
				text-decoration: none;
			}

		#buysafeContent blockquote {
			font-family: verdana;
			padding-left: 24px;
			font-size: 10px;
			margin: 0px;
			...
			font-weight: normal;
			color: #565a5c;
			background-image: url(http://www.buysafe.com/images/blockquote.gif);
			background-repeat: no-repeat;
		}

		#buysafeContent, #buysafeContent td {
			color: #333;
			font-size: 12px;
			line-height: 14px;
					...
					<td valign="top" align="center">
						...
						<table align="center" width="690" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">
							<tbody>
								<tr>
									<td>
										<img src="../app_themes/admin_default/images/buysafe/header06.gif" alt="buySAFE for AspDotNetStorefront" /></td>
								</tr>
							</tbody>
						</table>
									...
									<td width="690" bgcolor="#ffffff">
										<asp:Panel runat="server" Visible="false" ID="toppnlNotEnabledFreeTrialAvailable">
											...
											<asp:Panel ID="pnlBuySafeSignUp" runat="server">
												...
												<p style="margin: 4px 8px 2px 10px;">
													After extensive testing, we’ve proven that buySAFE significantly increases website conversions and customer satisfaction. We’ve negotiated a way for you to <strong>try buySAFE for 30 days, at no cost</strong>. This risk-free trial will allow you to see the impact that buySAFE will have on your business.<br />
													<br />
													Simply click the <strong>“Enable Free Trial”</strong> button below to automatically enable buySAFE on your site.
												</p>
												<br />
												<br />
												<p class="repeaterTitle">
													buySAFE provides a comprehensive consumer confidence solution that merchants leverage to build buyer confidence.
												...
												<div style="text-align: center;">
													<img src="../app_themes/admin_default/images/buysafe/buysafeworks.gif" border="0" />
												</div>
												<br />
												<br />
												...
												<div class="mainhighlight2" style="padding: 6px 0; text-align: right; color: #FFFFFF; background-image: url(../app_themes/admin_default/images/buysafe/CTAmerch_trial.gif); background-repeat: no-repeat; background-position: left;">
													...
													<br />
													<br />
													<div class="footertext" style="margin-right: 10px;">
														By enabling the Trial,you agree to<br />
														the <a target="_blank" href="http://buysafe.com/legal_notices/terms_and_conditions.html" style="color: white">buySAFE terms &amp; conditions</a>
													</div>
												</div>

												<p class="repeaterTitle">Who is using buySAFE:</p>
												<p style="margin: 4px 8px 2px 10px;">buySAFE is now used by nearly 10% of the Top 1000 online merchants and has guaranteed over 20,000,000 online purchases. It is a solution proven to increase customer satisfaction and overall sales by 5-15%.</p>
												<br />
												<br />
												<p align="center">
													<img src="../app_themes/admin_default/images/buysafe/logos_landing.gif" />
												</p>
												<br />
												<br />
											</asp:Panel>
										...
										<asp:Panel runat="server" Visible="false" ID="toppnlNotEnabledFreeTrialExpired">
											...
											<p>Please contact buySafe to enable register.</p>
											<br />
										...
										<asp:Panel runat="server" Visible="false" ID="toppnlWorking">
											...
											<asp:Panel runat="server" Visible="false" ID="pnlFreeTrialStatus">
												<b>
													<asp:Literal ID="litFreeDaysRemaining" runat="server" /></b><br />
												<br />
											</asp:Panel>
											<asp:Panel runat="server" ID="pnlRegisteredStores">
												...
												<asp:Panel ID="pnlActivated" runat="server" Visible="false">
													<b>You have successfully registered with buySAFE.<br />
														<br />
														<a href="https://www.buysafe.com/web/Login/SellerLogin.aspx" target="_blank">Click here to login to the buySAFE Merchant Dashboard.</a>
													</b>
												</asp:Panel>
										...
										<asp:Panel runat="server" Visible="false" ID="toppnlError">
											<br />
											<strong>There has been an error registering with buySAFE.<br />
												Please contact <a href="mailto:customersupport@buysafe.com">customersupport@buysafe.com</a> to sign up.</strong>
											<br />
											<br />
										</asp:Panel>
									</td>
