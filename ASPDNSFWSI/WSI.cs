			...
			try
			{
				...
				switch(NodeAction)
				{
					...
					case OrderManagementActionEnum.MarkAsShipped:
						...
						Status = Gateway.OrderManagement_MarkAsShipped(ord, XmlCommon.XmlAttribute(node, "ShippedCarrier"), XmlCommon.XmlAttribute(node, "TrackingNumber"), ShippedOn);
						Results.WriteXml(String.Format(" Status=\"{0}\">", XmlCommon.XmlEncodeAttribute(Status)));
						break;
					...
					case OrderManagementActionEnum.SendToFedexShippingMgr:
						Status = Gateway.OrderManagement_SendToFedexShippingMgr(ord);
						Results.WriteXml(String.Format(" Status=\"{0}\">", XmlCommon.XmlEncodeAttribute(Status)));
						break;
					case OrderManagementActionEnum.MarkAsPrinted:
						Status = Gateway.OrderManagement_MarkAsPrinted(ord);
						Results.WriteXml(String.Format(" Status=\"{0}\">", XmlCommon.XmlEncodeAttribute(Status)));
						break;
