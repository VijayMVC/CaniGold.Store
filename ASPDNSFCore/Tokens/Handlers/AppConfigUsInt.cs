...
{
	public class AppConfigUsInt : IParameterizedTokenHandler
	{
		const string NameParam = "name";

		readonly string[] Tokens = { "appconfigusint" };
		...
		public AppConfigUsInt(TokenParameterConverter tokenParameterConverter, AppConfigProvider appConfigProvider)
		{
		...
		public string RenderToken(TokenHandlerContext context)
		{
			...
			return AppConfigProvider
				.GetAppConfigValue<int>(appConfigName)
				.ToString();
		}
