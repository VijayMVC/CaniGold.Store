...
{
	public class AppConfigBool : IParameterizedTokenHandler
	{
		const string NameParam = "name";

		readonly string[] Tokens = { "appconfigbool" };
		...
		public AppConfigBool(TokenParameterConverter tokenParameterConverter, AppConfigProvider appConfigProvider)
		{
		...
		public string RenderToken(TokenHandlerContext context)
		{
			...
			return AppConfigProvider
				.GetAppConfigValue<bool>(appConfigName)
				.ToString();
		}
