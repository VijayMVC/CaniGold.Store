...
namespace AspDotNetStorefrontCore.Tokens.Handlers
{
	public class LookupImage : IParameterizedTokenHandler
	{
		...
		public string RenderToken(TokenHandlerContext context)
		{
			...
			var imageUrl = AppLogic.LookupImage(
			...
			return string.Format("<img class=\"actionelement product-image img-responsive\" src=\"{0}\" />", imageUrl);
		}
