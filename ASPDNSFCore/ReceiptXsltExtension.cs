...
namespace AspDotNetStorefrontCore
{
	public class ReceiptXsltExtension : XSLTExtensionBase
	{
		...
		public bool ShowBillingAddressForPaymentMethod(string paymentMethod)
		{
			return !StringComparer.OrdinalIgnoreCase.Equals(paymentMethod, AppLogic.ro_PMAmazonPayments)
				&& !StringComparer.OrdinalIgnoreCase.Equals(paymentMethod, AppLogic.ro_PMPayPalExpress);
		}
