...
namespace AspDotNetStorefrontCore
{
	...
	namespace CanadaPost
	{
		...
		[XmlRoot("ratesAndServicesRequest")]
		public partial class ratesAndServicesRequest
		{
		...
		[XmlRoot("ratesAndServicesResponse")]
		public partial class ratesAndServicesResponse
		{
		...
		[XmlRoot("emptySpace")]
		public partial class emptySpace
		{
			[XmlElement("length")] public string length;
			[XmlElement("width")] public string width;
			[XmlElement("height")] public string height;
		...
		[XmlRoot("nearestPostalOutlet")]
		public partial class nearestPostalOutlet
		{
